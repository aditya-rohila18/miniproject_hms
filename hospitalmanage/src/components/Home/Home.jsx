...
const Home = () => {
    ...
    const testimonials = [
      {
          name: "John Doe",
          text: "Health Next has revolutionized how I manage my healthcare. It's so easy to use!",
          image: "https://randomuser.me/api/portraits/men/32.jpg",
      },
      {
          name: "Jane Smith",
          text: "I love how I can access all my medical information in one place. Great job, Health Next!",
          image: "https://randomuser.me/api/portraits/women/44.jpg",
      },
      {
          name: "Mike Johnson",
          text: "Booking appointments has never been easier. Health Next is a game-changer!",
          image: "https://randomuser.me/api/portraits/men/22.jpg",
      },
      {
          name: "Emily Davis",
          text: "The staff is incredibly helpful and caring. I highly recommend Health Next!",
      ...
      {
          name: "Mary Brown",
          text: "I appreciate the convenience of managing everything online. Thank you, Health Next!",
