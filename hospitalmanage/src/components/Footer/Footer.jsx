...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: FaTwitter, href: 'https://x.com', color: 'text-blue-400' },
    { icon: FaFacebookF, href: 'https://www.facebook.com', color: 'text-blue-600' },
    { icon: FaInstagram, href: 'https://www.instagram.com', color: 'text-pink-500' },
    { icon: FaLinkedinIn, href: 'https://www.linkedin.com', color: 'text-blue-700' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-accent">Next Health</h3>
